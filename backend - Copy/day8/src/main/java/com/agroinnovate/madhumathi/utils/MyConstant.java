...
public class MyConstant {
        ...
        public static final String SWAGGER_INFO_DESCRIPTION ="My description";
        public static final String SWAGGER_INFO_VERSION ="1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME ="Madhumathi";
        public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs065@skcet.ac.in";
